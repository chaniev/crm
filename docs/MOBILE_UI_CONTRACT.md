...
Связанные требования: [REQ-NFR-001](requirements/08-нефункциональные.md#req-nfr-001-мобильность-интерфейса),
[REQ-NFR-005](requirements/08-нефункциональные.md#req-nfr-005-брендирование-клуба),
[REQ-NFR-006](requirements/08-нефункциональные.md#req-nfr-006-актуальность-данных-интерфейса).

Контракт уточняет принятые требования для UI и не создаёт самостоятельных CRM
business rules.
