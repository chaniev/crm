...
Базовые продуктовые ограничения: [REQ-NFR-001](../requirements/08-нефункциональные.md#req-nfr-001-мобильность-интерфейса)
и [REQ-NFR-005](../requirements/08-нефункциональные.md#req-nfr-005-брендирование-клуба).
Task-specific концепции дополнительно ссылаются на `REQ-*` из своей TASK-карточки.
