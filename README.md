...
Скрипт применяет миграции, затем пересоздает только свои детерминированные тестовые записи: 4 типа групп, 4 филиала по 3 зала, 10 тренеров, 5 администраторов, 30 групп и 300 клиентов с файлами фотографий. Пароль всех seed-пользователей: `Test1234!`.
