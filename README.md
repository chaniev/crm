...
Для чистого стенда, где нужны только пять администраторов филиала «Ленинский» без
пользовательского каталога абонементов, клиентов, групп, расписания и посещений:
...
сам seed элементы каталога не добавляет. Пароль администраторов: `1`.
