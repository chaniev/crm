...
public class BootstrapSmokeTests
{
    ...
    public void AddInfrastructure_registers_db_context_for_stage_one_model_smoke()
    {
        ...
        var dbContext = provider.GetRequiredService<CrmDbContext>();
        Assert.NotNull(dbContext);

        Assert.NotNull(dbContext.Model.FindEntityType("Crm.Domain.Users.User"));
        Assert.NotNull(dbContext.Model.FindEntityType("Crm.Domain.Clients.Client"));
        Assert.NotNull(dbContext.Model.FindEntityType("Crm.Domain.Clients.ClientMembership"));
        Assert.NotNull(dbContext.Model.FindEntityType("Crm.Domain.Groups.TrainingGroup"));
        Assert.NotNull(dbContext.Model.FindEntityType("Crm.Domain.Attendance.Attendance"));
        Assert.NotNull(dbContext.Model.FindEntityType("Crm.Domain.Audit.AuditLog"));
    }
