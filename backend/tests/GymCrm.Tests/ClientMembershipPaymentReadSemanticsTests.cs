...
public sealed class ClientMembershipPaymentReadSemanticsTests
{
    ...
    public void Removed_payment_actions_and_filters_have_stable_tombstone_problem_types()
    {
        ...
        Assert.Contains("membership-payment-filter-removed", clientEndpoints, StringComparison.Ordinal);
        ...
        Assert.Contains("StatusCodes.Status410Gone", clientEndpoints + botEndpoints, StringComparison.Ordinal);
    }
