...
internal static class PersistenceStartupExtensions
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var logger = app.Services
            ...
            .CreateLogger("GymCrm.Api.PersistenceStartup");
        ...
        {
            logger.LogDebug(
                "No DbContext types were discovered in loaded Gym CRM assemblies. Skipping migration startup flow.");
    ...
    private static IReadOnlyList<Type> DiscoverDbContextTypes(Type dbContextType)
    {
        return AppDomain.CurrentDomain
            ...
            .Where(assembly =>
                !assembly.IsDynamic &&
                assembly.GetName().Name?.StartsWith("GymCrm.", StringComparison.Ordinal) == true)
