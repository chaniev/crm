...
## Risks
- Settings section IA is clarified in `backlog/done/2026-05-13/TASK-030-crm-settings-section.md`; branch/hall scope should stay limited to the already agreed settings area.
