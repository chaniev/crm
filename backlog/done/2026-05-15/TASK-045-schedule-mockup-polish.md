...
Текущая завершенная основа расписания описана в `backlog/done/2026-05-14/TASK-043-schedule-calendar-like-view.md`: read-only weekly calendar на базе backend schedule data. Новая заметка не дублирует `TASK-043`, а задает следующую визуальную итерацию по конкретному макету.
...
- Related completed task: `backlog/done/2026-05-14/TASK-043-schedule-calendar-like-view.md`
