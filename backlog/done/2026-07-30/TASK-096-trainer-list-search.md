...
- implementation_plan: /backlog/done/2026-07-30/TASK-096-trainer-list-search.plan.md
...
- Related existing task: `backlog/done/2026-07-30/TASK-086-mobile-groups-search-filter-paging.md` покрывает часть заметки про группы.
