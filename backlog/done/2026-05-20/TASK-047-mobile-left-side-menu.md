...
Связанная завершенная задача: `backlog/done/2026-05-12/TASK-024-left-side-main-menu.md`. В ней левое меню было реализовано для desktop, а mobile navigation оставалась отдельным responsive-вариантом.
